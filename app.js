...
class Factory{
  ...
  static customerBuild(color, options){
    console.log("Building one " + color + " " + trim + " " + model + " with the following options");
  }
  constructor(){
    this.make = 'Mazda';
    this.location ='USA';
...
let newCar = new CAR("model", "doors", "enginetype", "transmission", "trim", "wheelstrim", "audio" , "seatstrim" ,"moonroof");
