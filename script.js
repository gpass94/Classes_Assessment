...
class Factory{
  static massBuild(quanity, options){
    console.log("Building " + quanity + color + trim + model);
  }
...
let newCar = new CAR("model", "doors", "color", "Mazda3", "transmission", "trim", "wheelstrim", "audio" , "seatstrim" ,"moonroof");
...
let newSportCar = new SPORT("model","trim", "transmission", "top", "color", "seatstrim", "audio", "wheelstrim");
...
let Truck = new TRUCK("model", "color", "enginesize", "hitch", "bed", "navigation");
